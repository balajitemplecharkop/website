    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-spiritual-beige px-4">
        <Card className="bg-white rounded-2xl shadow-spiritual p-8 max-w-md w-full flex flex-col items-center text-center">
          ...
          <Button
            className="bg-peacock-green text-white px-8 py-3 rounded-xl font-semibold shadow-spiritual hover:bg-peacock-green/90 transition"
      ...
      <div className="w-full max-w-lg mx-auto">
        <Card className="rounded-[2.5rem] shadow-2xl border-2 border-light-saffron/60 bg-gradient-to-br from-white via-light-saffron/30 to-peacock-green/10 p-2 md:p-4 backdrop-blur-md">
          <CardHeader className="text-center pb-2">
            ...
            <p className="text-deep-brown/70 mt-2 mb-2 text-base">
              Support us with a monthly Annadanam donation. Your recurring gift helps us serve fresh, sattvic meals to those in need, every month.
            </p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4 bg-light-saffron/10 rounded-xl p-4">
                ...
                <div className="flex flex-col">
                  <div className="relative flex items-center">
                    <span className="absolute left-3 flex items-center h-full text-light-saffron">
                  ...
                  <p className="text-xs text-deep-brown/60 mt-1 ml-2">
                    PAN Number is required for donations above ₹10,000 or to receive 80G certificate.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                      ...
                      className={`transition-all duration-150 px-6 py-2 rounded-full border-2 flex items-center gap-1 text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-deep-saffron/60 shadow-sm
                        ${
                          form.amount === amount.toString()
                            ? "bg-light-saffron border-deep-saffron text-deep-brown scale-105 ring-2 ring-deep-saffron"
                            : "bg-white border-light-saffron text-peacock-green hover:bg-light-saffron/60"
                        }
                      `}
                ...
                {!form.amount && <p className="text-red-500 text-sm mt-1">Please select a donation amount.</p>}
                <p className="text-sm text-deep-brown/70 mt-2 text-center">
                  Your donation will be automatically deducted every month. You can cancel anytime by contacting the temple helpline at +919920716663.
                </p>
              </div>
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <label htmlFor="auto-deduct-agree" className="text-xs text-deep-brown/80 select-none cursor-pointer">
                  I accept that the donation will be deducted automatically every month, and I will receive the invoice on
                  the provided WhatsApp number and email instantly after each deduction. By accepting, I agree to the above
                  statements.
                </label>
              </div>
              ...
              <Button
                ...
                disabled={!form.name || !form.email || !form.phone || !form.amount || !accepted}
              >
